...
class SiameseNetwork(nn.Module):
    ...
    def __init__(self,D1):
        ...
        self.cnn1 = nn.Conv2d(4, 4*self.D1, kernel_size=3,stride=1,padding=1)
        self.a1 = nn.LeakyReLU(0.5)
        self.cnn2 = nn.Conv2d(4*self.D1, 4*self.D1, kernel_size=3,stride=1,padding=1)
        self.a2 = nn.LeakyReLU(0.5)
        self.cnn3 = nn.Conv2d(4*self.D1, 8*self.D1, kernel_size=3,stride=1,padding=1)
        self.a3 = nn.LeakyReLU(0.5)
        
        self.cnn4 = nn.Conv2d(8*self.D1, 16*self.D1, kernel_size=3,stride=1,padding=1)
        self.a4 = nn.LeakyReLU(0.5)
        
        self.cnn5 = nn.Conv2d(16*self.D1, 8*self.D1, kernel_size=3,stride=1,padding=1)
        self.a5 = nn.LeakyReLU(0.5)
        self.cnn6 = nn.Conv2d(8*self.D1, 4*self.D1, kernel_size=3,stride=1,padding=1)
        self.a6 = nn.LeakyReLU(0.5)
        self.cnn7 = nn.Conv2d(4*self.D1, 4*self.D1, kernel_size=3,stride=1,padding=1)
        self.a7 = nn.LeakyReLU(0.5)
        
        self.cnn8 = nn.Conv2d(4*self.D1, 4, kernel_size=3,stride=1,padding=1)
        
        self.cnnXX1 = nn.Conv2d(4, 4*self.D1, kernel_size=3,stride=1,padding=1)
        self.axx1 = nn.LeakyReLU(0.5)

        self.cnnXX2 = nn.Conv2d(4, 4*self.D1, kernel_size=3,stride=1,padding=1)
        self.axx2 = nn.LeakyReLU(0.5)
        
        self.cnnXX3 = nn.Conv2d(4, 8*self.D1, kernel_size=3,stride=1,padding=1)
        self.axx3 = nn.LeakyReLU(0.5)
        
        self.cnnXX4 = nn.Conv2d(4, 16*self.D1, kernel_size=3,stride=1,padding=1)
        self.axx4 = nn.LeakyReLU(0.5)
       
        
        self.cnnXX5 = nn.Conv2d(4, 8*self.D1, kernel_size=3,stride=1,padding=1)
        self.axx5 = nn.LeakyReLU(0.5)
        
        self.cnnXX6 = nn.Conv2d(4, 4*self.D1, kernel_size=3,stride=1,padding=1)
        self.axx6 = nn.LeakyReLU(0.5) 
        
        self.cnnXX7 = nn.Conv2d(4, 4*self.D1, kernel_size=3,stride=1,padding=1)
        self.axx7 = nn.LeakyReLU(0.5)
        
        self.cnnXX = nn.Conv2d(4, 4, kernel_size=3,stride=1,padding=1)
